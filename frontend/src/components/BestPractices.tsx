...
export function BestPractices({ hygiene }: BestPracticesProps) {
  const checks = [
    ...
    },
    {
      name: 'README Quality',
      status:
        hygiene.readme_quality.has_setup && hygiene.readme_quality.has_test,
          ...
          <div key={category}>
            <h3 className="text-lg font-medium text-gray-900 mb-3 flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-500">
                ({categoryChecks.filter((c) => c.status).length}/
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-1 text-sm text-yellow-700">
                Consider addressing the failed checks to improve repository
                hygiene and development practices.
              </div>
            </div>
          </div>
        </div>
